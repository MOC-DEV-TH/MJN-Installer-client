...
class BuildTicketDetailInfo extends StatefulWidget {
  final String profileIdOrTicketID;
  String? status;

  BuildTicketDetailInfo(this.profileIdOrTicketID, {this.status});

  @override
  State<BuildTicketDetailInfo> createState() =>
      _BuildTicketDetailInfoState();
}

class _BuildTicketDetailInfoState extends State<BuildTicketDetailInfo> {
