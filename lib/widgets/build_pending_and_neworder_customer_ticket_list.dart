...
class BuildPendingAndNewOrderCustomerTicketList extends StatefulWidget {
  @override
  State<BuildPendingAndNewOrderCustomerTicketList> createState() =>
      _BuildPendingAndNewOrderCustomerTicketListState();
}

class _BuildPendingAndNewOrderCustomerTicketListState
    extends State<BuildPendingAndNewOrderCustomerTicketList>
                        ...
                        child: DropDownButtonComponent(
                          ...
                          onChangedData: (InstallationFilterStatus value) {
                            ...
                            if (value.name == "Select Status") {
                              ...
                              /**
                         * Service Ticket filter with status
                         */
                              if (PageArgumentController.to.getArgumentData() ==
                                  SERVICE_TICKET) {
                                if (PageArgumentController.to.getStatus() ==
                              ...
                              /**
                         *  Installation filter with status
                         */
                              else if (PageArgumentController.to
                                      .getArgumentData() ==
                                  INSTALLATION) {
                  ...
                  GetBuilder<HomeController>(
                      builder: (controller) => Expanded(
                            ...
                            onTap: () {
                              ...
                              if (HomeController
                                      .to.customerDateController.text ==
                                  "") {
                            ...
                            controller:
                                HomeController.to.customerDateController,
                            icon: Icons.search,
                            onPressIcon: () {
                              /**
                             * Service Ticket filter with date
                             */
                              if (PageArgumentController.to.getArgumentData() ==
                                  SERVICE_TICKET) {
                                if (PageArgumentController.to.getStatus() ==
        ...
        builder: (controller) => ListView.builder(
              ...
              itemCount: PageArgumentController.to.getArgumentData() ==
                  ...
                  : PageArgumentController.to.getArgumentData() ==
                      ...
                      : PageArgumentController.to.getArgumentData() ==
                              DEVICE_PICKUP
                          ? controller.devicePickupPendingCustomerList.length
      ...
      if (this.mounted) {
        if (PageArgumentController.to.getArgumentData() == INSTALLATION) {
          ...
          if (PageArgumentController.to.getStatus() == NEW_ORDER) {
            ...
            HomeController.to
                .fetchRelocationPendingCustomer('pending', '1', context);
          }
        }
      }
    });
