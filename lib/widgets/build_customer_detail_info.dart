...
class BuildCustomerDetailInfo extends StatefulWidget {
  ...
  @override
  State<BuildCustomerDetailInfo> createState() => _BuildCustomerDetailInfoState();
}
...
class _BuildCustomerDetailInfoState extends State<BuildCustomerDetailInfo> {
  ...
  Widget build(BuildContext context) {
    ...
    return Obx(() {
      ...
      return  PageArgumentController.to.getArgumentData() == INSTALLATION ? Flexible(
        child: Column(
          children: [
            Row(
                      ...
                      children: [
                        LabelTextComponent(
                            text: customerDetailController
                                .installationDetail.value.user_name == null ?
                        ...
                        LabelTextComponent(
                            text: customerDetailController
                                .installationDetail.value.firstname == null ?
                            "xx xxx xxx xxx xxx" : customerDetailController
